...
const Hero = () => {
  return (
    <section className="mt-28 flex flex-col items-center justify-center px-4 gap-12">
      ...
      <h3 className='font-medium font-urbanist text-neutral-500 text-xl max-w-2xl text-center leading-[1.1] tracking-tight'>
      ...
      <div className="w-full max-w-8xl mx-auto overflow-hidden rounded-[34px] shadow-2xl border-4 border-white/10">
        <video
          src="/Hero/Intro.mp4"
          loop
          playsInline
